...
presentation, a documentation to each slides. This helps me also to
...
command C<xwd>. Then it is converted in PNG image format, so that your
images will be viewable on most of browsers.
